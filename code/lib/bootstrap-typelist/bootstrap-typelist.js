/* =============================================================
 * based on bootstrap-typeahead.js v2.3.1-j6
...
!function($){
  ...
  * ================================= */
  ...
  var Typelist= function (element, options) {
    this.$element = $(element)
    this.options = $.extend({}, $.fn.typelist.defaults, options)
  ...
  $.fn.typelist = function (option) {
    return this.each(function () {
      var $this = $(this)
        , data = $this.data('typelist')
        , options = typeof option == 'object' && option
      if (!data) $this.data('typelist', (data = new Typelist(this, options)))
      if (typeof option == 'string') data[option]()
    })
  }

  $.fn.typelist.defaults = {
    source: []
  , items: 8
  , menu: '<ul class="typelist dropdown-menu"></ul>'
  , item: '<li><a href="#"></a></li>'
  , ajaxdelay: 400
  , minLength: 1
  }

  $.fn.typelist.Constructor = Typelist


 /* TYPEAHEAD NO CONFLICT
  * =================== */

  $.fn.typelist.noConflict = function () {
    $.fn.typelist = old
    return this
  }
  ...
  * ================== */
  ...
  $(document).on('focus.typelist.data-api', '[data-provide="typelist"]', function (e) {
      var $this = $(this)
      if ($this.data('typelist')) return
      if ($this.is('select')) $this.attr('autofocus', true)
      e.preventDefault()
      $this.typelist($this.data())
  })
